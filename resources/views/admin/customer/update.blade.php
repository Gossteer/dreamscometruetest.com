                        ...
                        <div class="form-validation">
                            <form method="POST" action="{{ route('customer.update', $customer) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 form-group contact-forms">
                                        <input id="Date_Birth_Customer" type="text" class="form-control" value="{{ date('d-m-Y', strtotime($customer->Date_Birth_Customerdate)) }}" name="Date_Birth_Customer" required placeholder="Дата рождения">
                                    </div>
