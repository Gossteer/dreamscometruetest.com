                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="{{ route('partners.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control @error('INN') is-invalid @enderror"  maxlength="12"  onKeyPress="if(this.value.length==12) return false;" value="{{ old('INN') }}"  name="INN" placeholder="ИНН">
                                        @error('Name_Partners')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 input-group">
                                        ...
                                        <div class="input-group-append" id="div_updatebutton">
                                            <a class="btn input-group-text selectedbutton diableddeletedbutton" data-toggle="modal" data-target="#addArticle1" id="updatebutton_type_activitie" style="" name="updatebutton_type_activitie" title="Изменить"><i class="fa fa-pencil color-danger"></i></a>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 input-group">
                                        <select class="custom-select @error('Address') is-invalid @enderror" multiple onchange="chenge_ubdate_button(this, 'updatebutton2');" id="Address" name="Address[]">
                                            <option value="null" id="dont_select_Address" selected >Без выбора</option>
                                        </select>
                                        <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 input-group">
                                        <select class="custom-select @error('Phone_Number') is-invalid @enderror" multiple onchange="chenge_ubdate_button(this, 'updatebutton3');" id="Phone_Number" name="Phone_Number[]">
                                            <option value="null" id="dont_select_Phone_Number" selected >Без выбора</option>
                                        </select>
                                        <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 input-group">
                                        <select class="custom-select @error('Email') is-invalid @enderror" multiple onchange="chenge_ubdate_button(this, 'updatebutton4');" id="Email" name="Email[]">
                                            <option value="null" id="dont_select_Email" selected >Без выбора</option>
                                        </select>
                                        <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 input-group">
                                        <select class="custom-select @error('Websites') is-invalid @enderror" multiple onchange="chenge_ubdate_button(this, 'updatebutton5');" id="Websites" name="Websites[]">
                                            <option value="null" id="dont_select_Websites" selected >Без выбора</option>
                                        </select>
                                        <div class="input-group-append">
