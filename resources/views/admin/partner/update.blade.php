                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="{{ route('partners.update', $partner->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control @error('INN') is-invalid @enderror"  maxlength="12"  onKeyPress="if(this.value.length==12) return false;" value="{{$partner->INN}}"  name="INN" placeholder="ИНН">
                                        @error('Name_Partners')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
