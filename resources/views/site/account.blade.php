    ...
    <section class="packages ">
        <div class="container py-lg-4 py-sm-3">
            ...
            @if($passengers->count() != 0)
                    ...
                    <div class="col-lg-3 col-sm-6 mb-4" href="">
                        ...
                        <div class="package-info">
                            ...
                            <ul class="listing mt-3" style="font-family: Open Sans, sans-serif;">
                                ...
                                @if($passenger->Occupied_Place_Bus)
                                <li><span  class="fa fa-location-arrow mr-2" ></span>Ваше место: {{$passenger->Occupied_Place_Bus}}</li>
                                @endif
                            </ul>
                ...
                @endif
            @else
                <h4 class="heading text-capitalize text-center mb-5" style="text-decoration: underline">Отсутствуют</h4>
            @endif
        </div>
    </section>
    ...
    <section class="packages ">
        <div class="container py-lg-4 py-sm-3">
            ...
            @if($passengers_end->count() != 0)
                ...
                @if($passengers_end->total() > $passengers_end->count())
                    <div class="row mb-5 justify-content-center">
                        <div class="bootstrap-pagination" >
                            <nav>
                                <ul class="pagination">
                                    {{ $passengers_end->links() }}
                                </ul>
                            </nav>
                        </div>
                    </div>
